...
let favActorFirstName = "Dr APJ Abdul";
let favActorLastName = "Kalam Azad";
let fullName = favActorFirstName + " " + favActorLastName;
let uppercase = fullName.toUpperCase();
let message = `My Favorite Actor is ${uppercase}, `;
message += `his best show is Missiles`;
console.log(message);
// My Favorite Actor is DR APJ ABDUL KALAM AZAD, his best show is silicon valley
