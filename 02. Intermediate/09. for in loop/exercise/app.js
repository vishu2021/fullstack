...
? Each property of the object represents the subject name (e.g., "Math", "Science") and the value represents the score. 
...
const averageScore1 = calculateAverageScore(testScores2);
console.log(averageScore1); //^ Output: 86.6
//! SOLUTION
