...
const Krishna = new Person("Krishna", "Radhe", "JavaScript");
console.log(Krishna);
console.log(Krishna.__proto__);
console.log(Krishna.__proto__.__proto__);
console.log(Krishna.__proto__.__proto__.__proto__);
